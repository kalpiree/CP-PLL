...
from utils.utils_algo import generate_uniform_cv_candidate_labels, generate_hierarchical_and_uniform_cv_candidate_labels
from utils.imbalance_cifar import IMBALANCECIFAR100


def load_cifar100_imbalance(partial_rate, batch_size, hierarchical, imb_type='exp', imb_factor=0.01, con=True,
    ...
    full_train_dataset = dsets.CIFAR100(root='./data', train=True, download=True, transform=test_transform)
    ...
    val_dataset = dsets.CIFAR100(root='./data', train=True, transform=test_transform)
    ...
    if disable_imbalancing:
        ...
        temp_train = IMBALANCECIFAR100(root='./data', train=True, download=True, imb_type=imb_type,
    ...
    if hierarchical:
        partialY = generate_hierarchical_and_uniform_cv_candidate_labels('cifar100', train_labels,
    ...
    train_dataset = CIFAR100_Augmentention(train_data, partialY.float(), train_labels.float(), con=con)
    ...
    #train_loader, partialY, val_loader,train_sampler, test_loader, cls_num_list_true_label
    #partialY
